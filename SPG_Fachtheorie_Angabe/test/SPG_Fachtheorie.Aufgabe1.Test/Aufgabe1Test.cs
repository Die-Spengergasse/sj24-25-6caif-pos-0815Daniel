...
namespace SPG_Fachtheorie.Aufgabe1.Test
{
    ...
    public class Aufgabe1Test
    {
        ...
        public void AddCashierSuccessTest()
        {
            //ARRANGE
            using var db = GetEmptyDbContext();
            var cashier = new Cashier(1, "Vorname", "Nachname", null, "Wursttheke");
            db.Cashiers.Add(cashier);

            //ACT
            db.SaveChanges(); //hier wird Insert gesendet
        ...
        public void AddPaymentSuccessTest()
        {
            //ARRANGE
            using var db = GetEmptyDbContext();
            var employee = new Cashier(1001, "Vorname", "Nachname", null, "Kassier");
            var cashDesk = new CashDesk(1);
            var payment = new Payment(cashDesk, new DateTime(2025, 2, 21), 1, employee);
        ...
        public void EmployeeDiscriminatorSuccessTest()
        {
            //ARRANGE
            using var db = GetEmptyDbContext();
            var manager = new Manager(1001, "VN", "NN", null, "BMW X7");
            ...
            //ASSERT
            db.ChangeTracker.Clear();
            var paymentFromDb = db.Managers.First();
            Assert.True(paymentFromDb.Type == "Manager");
        }
    }
}